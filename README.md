...
The following is generated by ChatGPT on March 2023:
...
Build composable artificial neural network architectures.
...
**Sample Usage:**
```python
from pyneurons import bind, create, apply

# Define a custom model
CustomModel = bind("CustomModel", create, apply)

# Create an instance of the custom model
model = CustomModel(3)  # Creates a model with 3 inputs
